...
public interface AdminRepository extends JpaRepository<Admin, Long> {
    ...
    // - The repository extends JpaRepository<Admin, Long>, which gives it basic
    // CRUD functionality.
    ...
    // repository.
    // - While it is technically optional (since JpaRepository is a part of Spring
    // Data), it's good practice to include it for clarity.
    // - Spring Data JPA automatically implements the repository, providing the
    // necessary CRUD functionality.
